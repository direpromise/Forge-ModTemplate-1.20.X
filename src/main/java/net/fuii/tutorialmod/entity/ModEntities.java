package net.fuii.tutorialmod.entity;

import net.fuii.tutorialmod.TutorialMod;
import net.fuii.tutorialmod.entity.custom.DiceProjectileEntity;
import net.fuii.tutorialmod.entity.custom.ModBoatEntity;
import net.fuii.tutorialmod.entity.custom.ModChestBoatEntity;
import net.fuii.tutorialmod.entity.custom.RhinoEntity;
